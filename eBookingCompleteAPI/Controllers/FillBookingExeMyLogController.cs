...
{
    public class FillBookingExeMyLogController : ApiController
    {
        ...
        public IEnumerable<ControlData> Post(BookingDetail objbookingDetail)
        {
            ...
            try
            {
                string strXml = "<ebooking><actionname>" + objbookingDetail.Parametername + "</actionname><username>" + objbookingDetail.ParamValueStr + "</username>"
