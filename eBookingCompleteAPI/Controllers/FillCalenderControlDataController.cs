...
{
    public class FillCalenderControlDataController : ApiController
    {
        ...
        public IEnumerable<ControlData> Post(BookingDetail objbookingDetail)
        {
            ...
            try
            {
                string strXml = "<ebooking><actionname>" + objbookingDetail.Parametername + "</actionname>"
                              ...
                              + "<backbookdaysflag>" + objbookingDetail.BackdateID + "</backbookdaysflag>"
                              + "<backbookdays>" + objbookingDetail.Backdatedays + "</backbookdays>"
                ...
                foreach (DataRow dr in objdt.Rows)
                {
                    ...
                    objcontroldata.Value = Convert.ToDateTime(dr[1]).ToString("dd/MM/yyyy");
