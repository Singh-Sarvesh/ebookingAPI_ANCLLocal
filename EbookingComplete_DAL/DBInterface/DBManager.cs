...
namespace DBInterface
{
    public sealed class DBManager : IDBManager, IDisposable
    {
        ...
        public DBManager()
        {
            ...
            this.strConnection = System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString;
        }
        ...
        {
            this.idbCommand = DBManagerFactory.GetCommand(this.ProviderType);
            this.idbCommand.CommandTimeout = 900000;
            PrepareCommand(idbCommand, this.Connection, this.Transaction,
